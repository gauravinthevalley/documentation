...
two settings that need configuration, the vehicle contract end date alert delay, and a new vehicle
request limit.
...
vehicle contracts. The responsible people will receive an email informing them a vehicle contract is
...
pre-configured :doc:`models <fleet/models>` from four major auto manufacturers and one major bicycle
